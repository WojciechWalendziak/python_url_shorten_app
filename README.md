Example of Django app to shorten URL addresses I have built it to get better knowlage about Django, following code (and guidlines) decribed in blog below:
